...
let input = parseFloat(prompt("Digite a primeira nota: "));
let input2 = parseFloat(prompt("Digite a segunda nota: "));
let input3 = parseFloat(prompt("Digite a terceira nota: "));
